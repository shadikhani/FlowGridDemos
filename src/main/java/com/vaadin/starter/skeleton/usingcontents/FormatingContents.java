package com.vaadin.starter.skeleton.usingcontents;
...
@Route("FormatingContents")
public class FormatingContents extends VerticalLayout {

	public FormatingContents() {
		...
		grid.addColumn(new LocalDateRenderer<>(Item::getEstimatedDeliveryDate,
				DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM))).setHeader("Estimated delivery date");
